...
const ChatContainer = ({m , userId}) => {
  ...
  return (
        ...
        <div className='flex justify-start mb-2'>
            ...
            <div className='max-w-sm bg-gradient-to-l from-gray-950 via-gray-800 to-purple-950 rounded-2xl rounded-tl-none py-2 px-4'>
            <h1 className='bg-gradient-to-r from-purple-500 via-cyan-500 to-violet-800 bg-clip-text text-transparent text-sm font-poppins font-medium'>
                    {`${username}`}
                </h1>
        ...
        <div className='max-w-sm bg-gradient-to-l from-cyan-600 via-purple-700 to-fuchsia-800 rounded-2xl rounded-tr-none py-2 px-4 text-end'>
            <div className='font-poppins font-light'>
            {`${m.text}`}
            </div>
            <div className='w-full text-xs text-gray-200'>
