...
const TeamCarousel = () => {
    ...
    const {get15Teams, top15Teams} = useExploreStore();
  
    useEffect(() => {
      get15Teams();
      
    },[])
    console.log("top15teams :",top15Teams);
  ...
  return (
      <div className="w-full max-w-full mx-4 px-4 relative bg-transparent z-30">
        <Slider {...settings}>
          ...
          <TeamCard/>
          <TeamCard/> */}
          {top15Teams.top15Teams?.map((ele, i) => (
            <TeamCard ele = {ele} />
          ))}
        </Slider>
      </div>
...
// I am thinking to show 10-15 on carousel and view all will redirect to page with full users 